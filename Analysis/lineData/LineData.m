function [lineData,yplot,xplot] = LineData(xLin,yLin,zlin)
imagesc(xLin,yLin,zlin)
xlabel('x(mm)');ylabel('y(mm)');
% set(gca,'YDir','normal'); 
set(gcf,'position',[900,100,1000,750])
%shading interp
colorbar;   colormap(jet(256)); %labelling
% caxis([Miniall Maxiall]); %labelling

[xdata, ydata] = ginput(2); hold on;
line([xdata(1) xdata(2)],[ydata(1) ydata(2)],...
'Color','w','LineStyle','--','DisplayName','Data line','LineWidth',2); hold off
