...
%
  ...
  methods (Static = true)
    ...
    function dS = fct(cs,varargin)
      dS = dislocationSystem(symmetrise(slipSystem.fct(cs),'antipodal'));
    end
    ...
    function dS = fccTwin(cs,varargin)
      dS = dislocationSystem(symmetrise(slipSystem.fccTwin(cs),'antipodal'));
    end
    
    function dS = bccTwin(cs,varargin)
      dS = dislocationSystem(symmetrise(slipSystem.bccTwin(cs),'antipodal'));
    end
    
    function dS = hcpTwin(cs,varargin)
      dS = dislocationSystem(symmetrise(slipSystem.hcpTwin(cs),'antipodal'));
    end
  end
