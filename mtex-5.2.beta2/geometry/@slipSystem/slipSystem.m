...
%
  ...
  methods (Static = true)
    ...
    function sS = fcc(cs,varargin)
      sS = [slipSystem(Miller(1,1,0,cs,'uvw'),Miller(-1,1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(1,0,0,cs,'uvw'),Miller(0,0,1,cs,'hkl'),varargin{:})];%,...
%             slipSystem(Miller(1,1,1,cs,'uvw'),Miller(-1,1,2,cs,'hkl'),varargin{:})
    end
    %{
     function sS = fccCrack(cs,varargin)
      if sum(cs.opt.plane == [1 0 0])==3
        sS = [slipSystem(Miller(1,1,0,cs,'uvw'),Miller(1,0,0,cs,'hkl'),varargin{:}),...
              slipSystem(Miller(1,1,0,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:})];
      elseif sum(cs.opt.plane == [1 1 0])==3
        sS = [slipSystem(Miller(1,1,1,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:}),...
              slipSystem(Miller(1,1,1,cs,'uvw'),Miller(1,1,2,cs,'hkl'),varargin{:})];
      end
    end
    %}
    function sS = fccTwin(cs,varargin)
      sS = slipSystem(Miller(-2,1,1,cs,'uvw'),Miller(1,1,1,cs,'hkl'),varargin{:});
    end
    
     function sS = bcc(cs,varargin)
      sS = [slipSystem(Miller(-1,1,1,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:}),...
            ... %slipSystem(Miller(-1,1,1,cs,'uvw'),Miller(3,1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(-1,1,1,cs,'uvw'),Miller(2,1,1,cs,'hkl'),varargin{:})];
     end
     
    function sS = bccTwin(cs,varargin)
      sS = slipSystem(Miller(-1,1,1,cs,'uvw'),Miller(2,1,1,cs,'hkl'),varargin{:});
    end
    
     function sS = fct(cs,varargin)
%       sS = [slipSystem(Miller(0,0,1,cs,'uvw'),Miller(1,0,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,0,1,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,1,0,cs,'uvw'),Miller(1,0,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(1,-1,0,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(1,-1,0,cs,'uvw'),Miller(1,1,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,1,1,cs,'uvw'),Miller(1,0,0,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,1,0,cs,'uvw'),Miller(0,0,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(1,1,0,cs,'uvw'),Miller(0,0,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,1,-1,cs,'uvw'),Miller(0,1,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(1,-1,1,cs,'uvw'),Miller(0,1,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(1,0,0,cs,'uvw'),Miller(0,1,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(0,1,-1,cs,'uvw'),Miller(2,1,1,cs,'hkl'),varargin{:}),...
%             slipSystem(Miller(-1,1,1,cs,'uvw'),Miller(2,1,1,cs,'hkl'),varargin{:})];
        
      sS = [slipSystem(Miller(0,1,1,cs,'uvw'),Miller(1,1,-1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(1,0,1,cs,'uvw'),Miller(1,1,-1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(1,-1,0,cs,'uvw'),Miller(1,1,-1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(0,-1,1,cs,'uvw'),Miller(-1,1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(-1,0,-1,cs,'uvw'),Miller(-1,1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(-1,-1,0,cs,'uvw'),Miller(-1,1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(0,1,1,cs,'uvw'),Miller(1,-1,1,cs,'hkl'),varargin{:}),...
            slipSystem(Miller(1,0,-1,cs,'uvw'),Miller(1,-1,1,cs,'hkl'),varargin{:}),...
     ...
     function sS = hcp(cs,varargin)
      sS = [slipSystem(Miller(1,1,-2,0,cs,'UVTW'),Miller(0,0,0,1,cs,'HKIL'),varargin{:}),...
           slipSystem(Miller(2,-1,-1,0,cs,'uvtw'),Miller(0,1,-1,0,cs,'hkil'),varargin{:}),...
           slipSystem(Miller(0,1,-1,0,cs,'uvtw'),Miller(2,-1,-1,0,cs,'hkl'),varargin{:}),...
           slipSystem(Miller(2,-1,-1,0,cs,'uvtw'),Miller(0,1,-1,1,cs,'hkl'),varargin{:}),...
           slipSystem(Miller(2,-1,-1,3,cs,'uvtw'),Miller(-1,1,0,1,cs,'hkl'),varargin{:}),...
           slipSystem(Miller(2,-1,-1,3,cs,'uvtw'),Miller(-2,1,1,2,cs,'hkl'),varargin{:})];   
     end
     
     function sS = hcpTwin(cs,varargin) 
sS = [slipSystem(Miller(1,-1,0,1,cs,'uvtw'),Miller(-1,1,0,2,cs,'hkl'),varargin{:}),... % tensil
      slipSystem(Miller(2,-1,-1,6,cs,'uvtw'),Miller(-2,1,1,1,cs,'hkl'),varargin{:}),... % tensil
      slipSystem(Miller(-1,1,0,-2,cs,'uvtw'),Miller(-1,1,0,1,cs,'hkl'),varargin{:}),...% compressive
      slipSystem(Miller(2,-1,-1,-3,cs,'uvtw'),Miller(2,-1,-1,2,cs,'hkl'),varargin{:})];% compressive
     end
