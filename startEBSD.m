...
while STEP<11
    switch STEP
        case 1
            ...
            try
            ebsd = loadEBSD([erase(fname, '.ctf') '.ctf'],'interface',...
                                'ctf','convertEuler2SpatialReferenceFrame');
            catch
...
% ebsd2abaqus(ebsd,fname)                         % Abaqus
    ...
    case 3
        ...
        STEP = 4;
    case 4
%         [sS,GSF,SFM,mP,TraceSy] = SchmidTaylorEBSD(CS,ebsd,Misanglede,grains,path); % taylor and schmid 
        STEP = 5;
    case 5
